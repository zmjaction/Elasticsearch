"""
Django settings for NewspySearch project.
...
SECRET_KEY = '9j++eg(&pvttznvoc0edsgitsr8a#xm5twfx(clxnhq)+13h@d'
...
ROOT_URLCONF = 'NewspySearch.urls'
...
WSGI_APPLICATION = 'NewspySearch.wsgi.application'
